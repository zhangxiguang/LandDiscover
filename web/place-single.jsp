            ...
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-md-7 hotel-single mt-4 mb-5 ftco-animate">
                        ...
                        <h2 style="margin: 0 0 20px -5px">${requestScope.placeInfo.name}</h2>
                        <span style="color: red;font-size: 25px">¥${requestScope.placeInfo.price}
                            <small>/人起</small></span>
                        <p class="rate mb-5" style="margin:20px 0 -60px 0">
                        ...
                        <p style="margin: 0 0 20px 2px;font-size: 16px">${requestScope.placeInfo.start_time}——${requestScope.placeInfo.end_time}
                            共${requestScope.placeInfo.time}游</p>
                        <p style="text-indent: 2em;margin-left: -2px;font-size: 16px">${requestScope.placeInfo.describe}</p>
                        <div class="d-md-flex mt-5 mb-5" style="font-size: 16px;margin-left: 13px">
                            <ul>
                                <li style="list-style: circle">服务保障：</li>
                                <li style="list-style: circle">供应商：</li>
                            </ul>
                            <ul class="ml-md-6">
                                <li>成团保障</li>
                                <li>自营</li>

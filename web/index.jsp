    ...
    <section class="ftco-section justify-content-end ftco-search">
    	<div class="container-wrap ml-auto">
          ...
          <div class="col-md-12 nav-link-wrap">
            <div class="nav nav-pills justify-content-center text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              <a class="nav-link active" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true">行程</a>

              <a class="nav-link" id="v-pills-2-tab" data-toggle="pill" href="#v-pills-2" role="tab" aria-controls="v-pills-2" aria-selected="false">宾馆</a>

              <a class="nav-link" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3" role="tab" aria-controls="v-pills-3" aria-selected="false">汽车租赁</a>
            </div>
          </div>
	  ...
	  <section class="ftco-about d-md-flex">
		  ...
		  <div class="one-half ftco-animate">
			  ...
			  <div>
				  <p>在路上她遇到了一本。抄本警告小盲文，它的来源将被重写一千遍，所有从它的起源留下的东西将是“和”这个词，小盲文应该转身回到它自己的安全的国家。但那份稿子上说的任何话都无法说服她，所以没过多久，几个阴险的文案伏击了她，让她喝得酩酊大醉，获得假释，把她拖进了他们的代理机构。</p>
			  </div>
		  </div>
	  </section>
